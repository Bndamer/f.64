...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2025 a las 21:32:26
...
INSERT INTO `accesorios` (`idAccesorios`, `nombreAccesorios`, `descripcionAccesorios`, `tipoAccesorios`, `precioAccesorios`, `fk_marcas`, `fkReseñas`, `imagenAccesorios`) VALUES
(10, 'Parasol Nikon d-23', 'Parasol compatible con lentes zoom', 'original', 15.00, 1, NULL, NULL),
(11, 'Parasol Nikon f-27', 'Parasol compatible con lentes angular', 'original y generico', 15.00, 1, NULL, NULL),
(12, 'Difusor Nikon e3', 'Difusor rigido compatible con flashes Nikon', 'original', 9.00, 1, NULL, NULL),
(14, 'Batería Canon LP-E6N', 'Batería recargable para cámaras Canon', 'original', 45.00, 2, NULL, NULL),
(15, 'Filtro UV 52mm', 'Filtro de protección UV para lentes de 52mm', 'genérico', 10.00, 3, NULL, NULL);
...
INSERT INTO `camaras` (`idCamaras`, `modeloCamaras`, `tipoCamaras`, `sensorCamaras`, `resolucionCamaras`, `isoMinCamaras`, `isoMaxCamaras`, `marca_id`, `precioCamaras`, `fkReseñas`, `imagenCamaras`) VALUES
(11, 'Nikon D7500', 'DSLR', 'APS-C', 20.90, 100, 51200, 1, 1200.00, NULL, 'd7500.jpg'),
(12, 'Canon EOS R5', 'Mirrorless', 'Full-frame', 45.00, 100, 51200, 2, 3900.00, NULL, 'r5.jpg'),
(13, 'Sony A7 III', 'Mirrorless', 'Full-frame', 24.20, 100, 51200, 3, 2000.00, NULL, 'a7iii.jpg'),
(14, 'Nikon Z6 II', 'Mirrorless', 'Full Frame', 24.50, 100, 51200, 1, 2000.00, NULL, 'z6ii.jpg'),
(15, 'Canon EOS M50 Mark II', 'Mirrorless', 'APS-C', 24.10, 100, 25600, 2, 700.00, NULL, 'm50.jpg'),
(16, 'Nikon D5600', 'DSRL', 'APS-C', 14.00, 100, 25600, 3, 800.00, NULL, 'd5600.jpg'),
(17, 'Nikon D850', 'DSLR', 'Full Frame', 45.70, 64, 25600, 1, 3000.00, NULL, 'd850.jpg'),
(18, 'Canon EOS 90D', 'DSLR', 'APS-C', 32.50, 100, 51200, 2, 1200.00, NULL, '90d.webp'),
(19, 'Sony A7R IV', 'Mirrorless', 'Full Frame', 61.00, 100, 32000, 3, 3500.00, NULL, 'a7riv.jpg'),
(20, 'Nikon Z7 II', 'Mirrorless', 'Full Frame', 45.70, 64, 25600, 1, 3000.00, NULL, 'z7ii.jpg'),
(21, 'Canon EOS Rebel T7', 'DSLR', 'APS-C', 24.10, 100, 6400, 2, 400.00, NULL, 't7.jpg'),
(23, 'Nikon D3100', 'DSRL', 'APS-C', 14.00, 100, 5600, NULL, 300.00, NULL, 'd3100.jpg');
...
CREATE TABLE `fotografos` (
  ...
  `añoNacimiento` year(4) DEFAULT NULL,
  `añoFallecimiento` year(4) DEFAULT NULL,
...
INSERT INTO `fotografos` (`idFotografo`, `nombreCompleto`, `nacionalidad`, `añoNacimiento`, `añoFallecimiento`, `estiloFotografico`, `biografia`, `imagenFotografo`) VALUES
(1, 'Annie Leibovitz', 'Estados Unidos', '1949', NULL, 'Retrato editorial', 'Famosa por sus retratos de celebridades para revistas como Vanity Fair y Rolling Stone. Estilo teatral y escenificado.', 'leibovitz.jpg'),
(2, 'Dorothea Lange', 'Estados Unidos', '0000', '1965', 'Documental', 'Reconocida por sus retratos de la Gran Depresión. Su foto \"Migrant Mother\" es un ícono del fotoperiodismo.', 'lange.jpg'),
(3, 'David LaChapelle', 'Estados Unidos', '1963', NULL, 'Fotografía artística y publicitaria', 'Conocido por su estilo saturado, surrealista y barroco. Ha trabajado con celebridades y campañas de alto impacto.', 'lachapelle.jpg'),
(4, 'Mario Testino', 'Perú', '1954', NULL, 'Moda y retrato', 'Uno de los fotógrafos de moda más influyentes. Ha trabajado con Vogue, Vanity Fair y la realeza británica.', 'testino.jpg'),
(5, 'Henri Cartier-Bresson', 'Francia', '1908', '2004', 'Fotografía callejera', 'Pionero del \"momento decisivo\", cofundador de la agencia Magnum. Estilo documental con gran precisión compositiva.', 'cartier_bresson.jpg'),
(6, 'Steve McCurry', 'Estados Unidos', '1950', NULL, 'Fotoperiodismo', 'Famoso por su retrato \"La niña afgana\". Ha cubierto conflictos y culturas alrededor del mundo.', 'mccurry.jpg'),
(7, 'Robert Capa', 'Hungría', '1913', '1954', 'Fotoperiodismo bélico', 'Fotógrafo de guerra y cofundador de Magnum Photos. Documentó cinco guerras distintas.', 'capa.jpg'),
(8, 'Sebastião Salgado', 'Brasil', '1944', NULL, 'Documental y humanista', 'Conocido por sus series sobre migración, pobreza y naturaleza. Enfocado en la condición humana.', 'salgado.jpg'),
(9, 'Vivian Maier', 'Estados Unidos', '1926', '2009', 'Fotografía callejera', 'Niñera que documentó la vida urbana de Chicago y Nueva York. Su trabajo fue descubierto post mortem.', 'maier.jpg'),
(10, 'Diane Arbus', 'Estados Unidos', '1923', '1971', 'Retrato psicológico', 'Exploró lo marginal y lo extraño. Su obra es inquietante y profundamente humana.', 'arbus.jpg'),
(11, 'Richard Avedon', 'Estados Unidos', '1923', '2004', 'Moda y retrato', 'Revolucionó la fotografía de moda con dinamismo. Retrató a figuras emblemáticas del siglo XX.', 'avedon.jpg'),
(12, 'Helmut Newton', 'Alemania', '1920', '2004', 'Moda y erotismo', 'Conocido por sus imágenes provocadoras y estilizadas. Marcó una época en la fotografía de moda.', 'newton.jpg'),
(13, 'Gordon Parks', 'Estados Unidos', '1912', '2006', 'Documental y retrato', 'Primer fotógrafo afroamericano en Life. Documentó temas raciales y sociales.', 'parks.jpg'),
(14, 'Man Ray', 'Estados Unidos', '0000', '1976', 'Experimental y surrealismo', 'Pionero del dadaísmo y surrealismo en fotografía. Innovador en técnicas como la solarización.', 'manray.jpg'),
(15, 'Irving Penn', 'Estados Unidos', '1917', '2009', 'Moda y retrato', 'Reconocido por su trabajo con Vogue. Retratos simples y elegantes, con atención al detalle.', 'penn.jpg');
...
INSERT INTO `lentes` (`idLentes`, `modeloLentes`, `tipoLentes`, `aperturaMinLentes`, `aperturaMaxLentes`, `distanciaFocalLentes`, `marca_id`, `precioLentes`, `fkReseñas`, `imagenLentes`) VALUES
(7, 'Nikkor 24-70mm f/2.8', 'Zoom', 0.00, 0.00, 24.0, 1, 1800.00, NULL, NULL),
(8, 'Canon EF 50mm f/1.8 STM', 'Prime', 0.00, 0.00, 50.0, 2, 125.00, NULL, NULL),
(9, 'Sony FE 70-200mm f/4 G OSS', 'Zoom', 0.00, 0.00, 70.0, 3, 1500.00, NULL, NULL),
(10, 'Nikon AF-S 50mm f/1.8G', 'Prime', 1.80, 16.00, 50.0, 1, 200.00, NULL, NULL),
(11, 'Canon EF 24-70mm f/2.8L II USM', 'Zoom', 2.80, 22.00, 24.0, 2, 1600.00, NULL, NULL),
(12, 'Sony FE 85mm f/1.4 GM', 'Prime', 1.40, 16.00, 85.0, 3, 1800.00, NULL, NULL),
(13, 'Nikon AF-P DX 70-300mm f/4.5-6.3G', 'Zoom', 4.50, 22.00, 70.0, 1, 400.00, NULL, NULL),
(14, 'Nikon AF-S 17 - 55mm f/2.8G', 'Prime Zoom', 2.80, 22.00, 17.0, 1, 700.00, NULL, NULL),
(15, 'Sony E 16-55mm f/2.8 G', 'Zoom', 2.80, 22.00, 16.0, 3, 1400.00, NULL, NULL);
...
--
ALTER TABLE `fotografos`
  MODIFY `idFotografo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
